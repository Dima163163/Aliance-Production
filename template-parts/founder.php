<section class="section section-founder">
      <picture>
        ...
        <img src="img/founder.jpg" alt="founder" class="<?= $founder_foto; ?>" width="840" height="660">
      </picture>
      <div class="container container-founder">
        <div class="founder-content-wrapper">
          <div class="founder-content">
            ...
            <p class="text founder-text founder-text-bottom">
            ...
            <a href="./about.php" class="<?= $founder_button_style; ?>"><?= $founder_button_text; ?></a>
          </div>
          <!-- /.founder-content -->
        </div>
      </div>
